...
## v8.7.1 — Редакторская чистка Эпохи I

- Полностью переписаны 264 миссии эпохи «Рождение цивилизаций».
- Очищены Месопотамия, ранний Египет, Индская цивилизация, ранний Китай и две сравнительные кампании.
- Доля точных межмиссионных повторов в Эпохе I снижена с 87,08% до 1,73%.
- Добавлен обязательный аудит дублей в `npm test`.
- Сейвы, карточки, миссии и прогресс не меняют идентификаторы.
- Patch-only архив.

## v8.7.1 — Китай: от Тан к Сун
