# Codex of History v8.7.2
## v8.7.2 — завершённая исследовательская пересборка Эпохи I

- Эпоха «Рождение цивилизаций» теперь содержит 102 самостоятельных урока вместо 204 раздробленных миссий.
- Месопотамия и ранний Египет: по 30 уроков.
- Индская цивилизация: 14 уроков по семи главам.
- Ранний Китай: 16 уроков по восьми главам.
- Сравнение Египта и Месопотамии: 6 крупных уроков.
- Общий слой первых цивилизаций: 6 итоговых уроков.
- Каждый текст привязан к конкретным памятникам, датам, технологиям и ограничениям источников.
- Удалённые ID автоматически перенаправляются на объединённые уроки; сейвы и открытые этапы сохраняются.
- Автоматический аудит запрещает генераторные формулировки, повтор названия урока и копирование длинных предложений.
...
## v8.7.2
Месопотамия и ранний Египет пересобраны в 60 исследовательских уроков без искусственного дробления и текстовых шаблонов.
