# Codex of History v8.7.1
## v8.7.1 — исследовательская пересборка Месопотамии и раннего Египта

- 120 искусственно раздробленных миссий объединены в 60 самостоятельных уроков.
- Состав уроков определяется объёмом реального материала, а не обязательной сеткой из шести миссий.
- У каждого урока собственные факты, хронология, понятия, причинный разбор, теория, практика и проверяемые источники.
- Старые ID переведены на объединённые миссии; прогресс и открытые этапы сохраняются.
- Добавлен тест против генераторных фраз, одинаковых целей и массового копирования предложений.
