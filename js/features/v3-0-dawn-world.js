/* Codex v3.3.0 — first civilizations shared era layer */
(()=>{
  const V='3.3.0';window.CODEX_VERSION=V;V22_CAMPAIGN_CODES.DAWN_WORLD='CIVILIZATIONS';
