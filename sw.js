/* Codex of History v3.7.0 — bounded GitHub Pages service worker with session-only remote card images */
const VERSION='codex-v3.7.0';
...
const CORE=[
  ...
  './assets/packs/civilizations-pack.svg','./assets/packs/babylon-pack.svg','./assets/packs/egypt-bronze-pack.svg','./assets/packs/international-bronze-pack.svg','./assets/packs/bronze-collapse-pack.svg','./assets/packs/hittites-pack.svg','./assets/packs/aegean-pack.svg','./assets/packs/bronze-era-pack.svg',
  './data/image_manifest.json','./data/image_queries.json',
  './js/features/v3-2-egypt-middle-new.js','./js/features/v3-3-hittites.js','./js/features/v3-4-aegean.js','./js/features/v3-5-international.js','./js/features/v3-6-collapse.js','./js/features/v3-7-bronze-world.js','./js/features/v3-1-1-hotfix.js','./js/features/v3-1-3-visual-semantics.js'
];
