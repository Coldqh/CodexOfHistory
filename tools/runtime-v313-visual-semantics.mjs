...
const queryPayload={version:'7.1.0',count:3,cards:{
...
const context={
  ...
  CODEX_MANIFEST:{version:'7.1.0',datasets:{imageQueries:'data/image_queries.json'}},
...
console.log('✓ v7.1.0 keeps validated visuals only in session storage and rejects tiger/goat pages');
