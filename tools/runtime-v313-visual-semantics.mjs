...
const queryPayload={version:'3.1.4',count:3,cards:{
...
assert.ok(store.has('codex_history_visual_archive_v314'));
console.log('✓ v3.1.4 rejects tiger/goat pages and accepts Tigris/Cosa historical pages');
