...
const queryPayload={version:'4.0.0',count:3,cards:{
...
const context={
  ...
  CODEX_MANIFEST:{version:'4.0.0',datasets:{imageQueries:'data/image_queries.json'}},
...
console.log('✓ v4.0.0 keeps validated visuals only in session storage and rejects tiger/goat pages');
