...
const queryPayload={version:'8.7.0',count:3,cards:{
...
const context={
  ...
  CODEX_MANIFEST:{version:'8.7.0',datasets:{imageQueries:'data/image_queries.json'}},
...
console.log('✓ v8.7.0 keeps validated visuals only in session storage and rejects tiger/goat pages');
