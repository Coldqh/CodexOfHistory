...
const queryPayload={version:'3.1.3',count:3,cards:{
...
assert.ok(renders>0);
assert.ok(store.has('codex_history_visual_archive_v313'));
console.log('✓ v3.1.3 rejects tiger/goat pages and accepts Tigris/Cosa historical pages');
