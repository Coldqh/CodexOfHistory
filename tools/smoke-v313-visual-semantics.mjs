...
assert.match(sw,/codex-v3\.5\.1/);
assert.match(sw,/v3-1-3-visual-semantics\.js/);

console.log(`✓ v3.5.1 semantic visual catalog: ${cards.length} profiles, ${staticHistorical.length} fixed, ${dynamic.length} validated dynamically`);
