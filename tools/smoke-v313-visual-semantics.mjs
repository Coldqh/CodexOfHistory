...
for(const token of ['pageterms','extracts','categories','semanticDecision','wrong-history-context','forbidden-context','MAX_CONTEXT_REUSE=8','codex_history_visual_archive_v314']){
