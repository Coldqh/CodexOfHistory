...
assert.match(sw,/codex-v8\.6\.0/);
assert.match(sw,/v3-1-3-visual-semantics\.js/);

console.log(`✓ v8.6.0 semantic visual catalog: ${cards.length} profiles, ${staticHistorical.length} fixed, ${dynamic.length} validated dynamically`);
