...
assert.match(sw,/codex-v7\.4\.0/);
assert.match(sw,/v3-1-3-visual-semantics\.js/);

console.log(`✓ v7.4.0 semantic visual catalog: ${cards.length} profiles, ${staticHistorical.length} fixed, ${dynamic.length} validated dynamically`);
