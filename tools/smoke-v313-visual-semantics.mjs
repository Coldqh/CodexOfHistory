...
for(const token of ['pageterms','extracts','categories','semanticDecision','wrong-history-context','forbidden-context','MAX_CONTEXT_REUSE=8','codex_history_visual_archive_v313']){
...
assert.match(sw,/codex-v3\.1\.3/);
assert.match(sw,/v3-1-3-visual-semantics\.js/);

console.log(`✓ v3.1.3 semantic visual catalog: ${cards.length} profiles, ${staticHistorical.length} fixed, ${dynamic.length} validated dynamically`);
