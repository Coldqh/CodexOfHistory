...
for(const file of ['assets/ui/codex-logo-mark.png','assets/ui/codex-icon-180.png','assets/ui/codex-icon-192.png','assets/ui/codex-icon-512.png','assets/ui/codex-icon-maskable-512.png','assets/ui/codex-favicon-32.png','assets/ui/codex-favicon-16.png']){
...
console.log('✓ v3.2.2 logo is wired into desktop, mobile, favicon and PWA icons');
