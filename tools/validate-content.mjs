...
const [relations,campaign,pools,quizzes,stories,daily]=await Promise.all([read(d.relations),read(d.campaign),read(d.pools),read(d.quizzes),read(d.stories),read(d.daily)]);
const ids=new Set();
